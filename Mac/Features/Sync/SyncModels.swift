    ...
    var fields: [Field] {
        ...
        case .host(let l, let lp, let r, let rp):
            ...
            return [
                ...
                Field(label: String(localized: "启用主机监控"),
                      local: l.ssh?.monitoringEnabled == false ? String(localized: "关") : String(localized: "开"),
                      remote: r.ssh?.monitoringEnabled == false ? String(localized: "关") : String(localized: "开")),
                Field(
